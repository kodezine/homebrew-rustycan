cask "rustycan" do
  version "0.2.0"
  sha256 "187021248ff9966f1a0129d0abdf84a0ed8e91769be2ee150845025f2d6553a8"

  url "https://github.com/kodezine/RustyCAN/releases/download/v0.2.0/rustycan-v0.2.0-aarch64-apple-darwin.dmg"
  name "RustyCAN"
